...
public:
    ...
    virtual int mkdir(const char* path) override { return -1; }
    virtual int unlink(const char* path) override { return -1; }
    virtual int rmdir(const char* path) override { return -1; }
};
